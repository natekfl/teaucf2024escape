            ...
            <div className="flex flex-col items-stretch mb-10">
                ...
                <div className="rounded-b-lg border-solid border-x-2 border-b-2 border-white p-6">
                    <div className="flex flex-col items-stretch mb-4">
                        ...
                        <div className="flex flex-row flex-wrap border-solid border-x-2 border-b-2 border-gray-300 p-6">
                        ...
                        <div className="flex flex-row flex-wrap rounded-b-lg border-solid border-x-2 border-b-2 border-gray-300 p-6">
...
function BooleanValue(props: BooleanValueProps) {
    return (
        <div className="p-2 text-lg font-bold uppercase mr-6 inline-flex items-center justify-center" style={{ backgroundColor: props.value ? "green" : "red" }}>
...
function BooleanValueOutlined(props: BooleanValueProps) {
    return (
        <div className="p-2 text-lg font-bold uppercase mr-6 border-solid border-2 inline-flex items-center justify-center" style={{ borderColor: props.value ? "green" : "red" }}>
            {props.value ? props.trueText : props.falseText}
        </div>
    )
}
...
function NumericValue(props: NumericValueProps) {
    return (
        <div className="p-2 text-lg font-bold uppercase mr-6 border-solid border-white border-2 inline-flex items-center justify-center">
...
function HmiButton(props: HmiButtonProps) {
    return (
        <button
            ...
            className="p-2 text-lg text-white font-bold uppercase mr-6 inline-flex items-center justify-center"
            style={{
                background: "#7C7C7C",
