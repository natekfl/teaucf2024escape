...
export declare interface Room5BricksDevice {
...
export class Room5BricksDevice extends BaseDevice {
    static #device: Room5BricksDevice | undefined = undefined
    ...
    static assignDevice(dev: UnknownDevice) {
        ...
        this.#device = new Room5BricksDevice(dev.detachSocket())
    }
    // ---------- //
